...
/home/maxi/Documentos/GitHub/BlockBreaker_SD2/Spartan6Memctrl:

   - mimasv2_s6_lpddr.vho:
        vho template file containing code that can be used as a model
        for instantiating a CORE Generator module in a HDL design.

   - mimasv2_s6_lpddr.xco:
       CORE Generator input file containing the parameters used to
       regenerate a core.

   - mimasv2_s6_lpddr_flist.txt:
        Text file listing all of the output files produced when a customized
        core was generated in the CORE Generator.

   - mimasv2_s6_lpddr_readme.txt:
        Text file indicating the files generated and how they are used.

   - mimasv2_s6_lpddr_xmdf.tcl:
        ISE Project Navigator interface file. ISE uses this file to determine
        how the files output by CORE Generator for the core can be integrated
        into your ISE project.

   - mimasv2_s6_lpddr directory.

In the mimasv2_s6_lpddr directory, three folders are created:
   - docs:
